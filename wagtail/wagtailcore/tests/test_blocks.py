...
class TestPageChooserBlock(TestCase):
    ...
    def test_form_render(self):
        ...
        self.assertIn('createPageChooser("page", ["wagtailcore.page"], null, false, true);', empty_form_html)
    ...
    def test_form_render_with_can_choose_root(self):
        ...
        empty_form_html = block.render_form(None, 'page')
        self.assertIn('createPageChooser("page", ["wagtailcore.page"], null, true, true);', empty_form_html)
